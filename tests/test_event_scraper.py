...
def test_scrape_all_events(mocker):
    with open('mocks/all_events.html', 'r') as file:
        mocker.patch('scrapers.event_scraper.EventScraper.get_html', return_value=file.read())
    ...
    assert first_event.image_url == "https://imagenes.alpogo.com/eventos/alta_evento_1739829950_67b3b2be91753.jpg"
...
def test_scrape_casa_astral(mocker):
    ...
    assert first_event.image_url == "https://imagenes.alpogo.com/eventos/21LEDZEPPELIN.png"
    assert first_event.url == "https://alpogo.com/evento/musica-a-ciegas-led-zeppelin-18382"
